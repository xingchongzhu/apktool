...
/* renamed from: c.a.a.a.m2.o */
public final class FileTypes {
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static int m10335a(java.lang.String r17) {
        /*
            r0 = -1
            if (r17 != 0) goto L_0x0004
            return r0
        L_0x0004:
            java.lang.String r1 = p067c.p068a.p069a.p070a.p111m2.MimeTypes.m10412r(r17)
            r1.hashCode()
            int r2 = r1.hashCode()
            r3 = 14
            r4 = 13
        ...
        L_0x0172:
            return r16
        */
        throw new UnsupportedOperationException("Method not decompiled: p067c.p068a.p069a.p070a.p111m2.FileTypes.m10335a(java.lang.String):int");
    }

    /* renamed from: b */
    public static int m10336b(Map<String, List<String>> map) {
        List list = (List) map.get("Content-Type");
        return m10335a((list == null || list.isEmpty()) ? null : (String) list.get(0));
    }

    /* renamed from: c */
    public static int m10337c(Uri uri) {
        ...
        if (!lastPathSegment.endsWith(str)) {
            if (!lastPathSegment.startsWith(".m4", lastPathSegment.length() - 4) && !lastPathSegment.startsWith(str, lastPathSegment.length() - 5)) {
                if (!lastPathSegment.startsWith(".cmf", lastPathSegment.length() - 5)) {
                    ...
                    String str2 = ".ts";
                    if (lastPathSegment.endsWith(str2) || lastPathSegment.startsWith(str2, lastPathSegment.length() - 4)) {
                        return 11;
                    }
