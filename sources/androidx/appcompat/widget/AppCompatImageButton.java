...
public class AppCompatImageButton extends ImageButton implements TintableBackgroundView, TintableImageSourceView {
    ...
    /* renamed from: a */
    private final AppCompatBackgroundHelper f1120a;

    /* renamed from: b */
    private final AppCompatImageHelper f1121b;
    ...
    public void drawableStateChanged() {
        ...
        AppCompatBackgroundHelper eVar = this.f1120a;
        if (eVar != null) {
            eVar.mo1388b();
        }
        AppCompatImageHelper nVar = this.f1121b;
        if (nVar != null) {
            nVar.mo1617b();
        }
    }
    ...
    public boolean hasOverlappingRendering() {
        return this.f1121b.mo1620e() && super.hasOverlappingRendering();
    }
