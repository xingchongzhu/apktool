...
public class AppCompatRadioButton extends RadioButton implements TintableCompoundButton, TintableBackgroundView {
    ...
    /* renamed from: a */
    private final AppCompatCompoundButtonHelper f1200a;

    /* renamed from: b */
    private final AppCompatBackgroundHelper f1201b;

    /* renamed from: c */
    private final AppCompatTextHelper f1202c;

    public AppCompatRadioButton(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0502a.f3270F);
    }

    /* access modifiers changed from: protected */
    public void drawableStateChanged() {
        super.drawableStateChanged();
        AppCompatBackgroundHelper eVar = this.f1201b;
        if (eVar != null) {
            eVar.mo1388b();
        }
        AppCompatTextHelper zVar = this.f1202c;
        if (zVar != null) {
            zVar.mo1864b();
        }
    }
    ...
    public int getCompoundPaddingLeft() {
        ...
        AppCompatCompoundButtonHelper iVar = this.f1200a;
