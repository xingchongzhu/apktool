...
public abstract class JsonGenerator implements Closeable, Flushable, Versioned {
    ...
    static /* synthetic */ class C17701 {
        ...
        static final /* synthetic */ int[] f11505xa51b40dc;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f11505xa51b40dc     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f11505xa51b40dc     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f11505xa51b40dc     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f11505xa51b40dc     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.core.JsonGenerator.C17701.<clinit>():void");
        }
    }
                ...
                switch (nextToken.mo10463id()) {
                    ...
                    case 8:
                        ...
                        if (numberType2 != NumberType.BIG_DECIMAL) {
                            if (numberType2 != NumberType.FLOAT) {
                    ...
                    default:
                        ...
                        sb.append("Internal error: unknown current token, ");
                        sb.append(nextToken);
    ...
    public WritableTypeId writeTypePrefix(WritableTypeId writableTypeId) throws IOException {
        Object obj = writableTypeId.f11524id;
        ...
        if (canWriteTypeId()) {
            ...
            int i = C17701.f11505xa51b40dc[inclusion.ordinal()];
            if (!(i == 1 || i == 2)) {
                if (i == 3) {
    ...
    public WritableTypeId writeTypeSuffix(WritableTypeId writableTypeId) throws IOException {
        ...
        if (writableTypeId.wrapperWritten) {
            int i = C17701.f11505xa51b40dc[writableTypeId.include.ordinal()];
            if (i == 1) {
                Object obj = writableTypeId.f11524id;
