...
import com.fasterxml.jackson.core.p194io.MergedStream;
import com.fasterxml.jackson.core.p194io.UTF32Reader;
...
public final class ByteSourceJsonBootstrapper {
    ...
    public JsonParser constructParser(int i, ObjectCodec objectCodec, ByteQuadsCanonicalizer byteQuadsCanonicalizer, CharsToNameCanonicalizer charsToNameCanonicalizer, int i2) throws IOException {
        int i3 = i2;
        int i4 = this._inputPtr - this._inputPtr;
        ...
        UTF8StreamJsonParser uTF8StreamJsonParser = new UTF8StreamJsonParser(this._context, i5, this._in, objectCodec2, byteQuadsCanonicalizer.makeChild(i3), this._inputBuffer, this._inputPtr, this._inputEnd, i4, this._bufferRecyclable);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:7:0x003f, code lost:
        if (checkUTF16(r1 >>> com.umeng.analytics.pro.TType.f16865n) != false) goto L_0x005e;
     */
