...
import com.fasterxml.jackson.core.p194io.JsonEOFException;
...
public abstract class ParserMinimalBase extends JsonParser {
    ...
    public void reportOverflowInt(String str, JsonToken jsonToken) throws IOException {
        _reportInputCoercion(String.format("Numeric value (%s) out of range of int (%d - %s)", new Object[]{_longIntegerDesc(str), Integer.valueOf(Integer.MIN_VALUE), Integer.valueOf(Integer.MAX_VALUE)}), jsonToken, Integer.TYPE);
    }

    /* access modifiers changed from: protected */
    public void reportOverflowLong(String str, JsonToken jsonToken) throws IOException {
        _reportInputCoercion(String.format("Numeric value (%s) out of range of long (%d - %s)", new Object[]{_longIntegerDesc(str), Long.valueOf(Long.MIN_VALUE), Long.valueOf(Long.MAX_VALUE)}), jsonToken, Long.TYPE);
    }
