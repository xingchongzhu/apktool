...
public abstract class ParserBase extends ParserMinimalBase {
    ...
    public char _handleUnrecognizedCharacterEscape(char c) throws JsonProcessingException {
        ...
        sb.append(ParserMinimalBase._getCharDesc(c));
    ...
    public String _validJsonValueList() throws IOException {
        return isEnabled(Feature.ALLOW_NON_NUMERIC_NUMBERS) ? "(JSON String, Number (or 'NaN'/'INF'/'+INF'), Array, Object or token 'null', 'true' or 'false')" : "(JSON String, Number, Array, Object or token 'null', 'true' or 'false')";
    }
