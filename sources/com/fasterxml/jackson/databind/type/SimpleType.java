...
public class SimpleType extends TypeBase {
    ...
    public static SimpleType construct(Class<?> cls) {
        ...
        if (Map.class.isAssignableFrom(cls)) {
            ...
            sb.append("Cannot construct SimpleType for a Map (class: ");
            sb.append(cls.getName());
            sb.append(str);
            throw new IllegalArgumentException(sb.toString());
        } else if (Collection.class.isAssignableFrom(cls)) {
            StringBuilder sb2 = new StringBuilder();
            sb2.append("Cannot construct SimpleType for a Collection (class: ");
            ...
            sb3.append("Cannot construct SimpleType for an array (class: ");
    ...
    public JavaType _narrow(Class<?> cls) {
        ...
        if (superclass == cls3) {
            ...
            StringBuilder sb = new StringBuilder();
            sb.append("Internal error: Cannot resolve sub-type for Class ");
            sb.append(cls.getName());
            sb.append(" to ");
            ...
            Class<?> cls6 = cls;
            SimpleType simpleType5 = new SimpleType(cls6, this._bindings, _narrow(superclass), null, this._valueHandler, this._typeHandler, this._asStatic);
            return simpleType5;
        }
    }
