...
public class SimpleSerializers extends Base implements Serializable {
    ...
    public void addSerializer(JsonSerializer<?> jsonSerializer) {
        ...
        if (handledType == null || handledType == Object.class) {
            ...
            sb.append(" does not define valid handledType() -- must either register with method that takes type argument  or make serializer extend 'com.fasterxml.jackson.databind.ser.std.StdSerializer'");
    ...
    public JsonSerializer<?> findSerializer(SerializationConfig serializationConfig, JavaType javaType, BeanDescription beanDescription) {
        ...
        if (rawClass.isInterface()) {
            ...
            if (hashMap != null) {
                JsonSerializer<?> jsonSerializer = (JsonSerializer) hashMap.get(classKey);
                if (jsonSerializer != null) {
                    return jsonSerializer;
                }
            }
