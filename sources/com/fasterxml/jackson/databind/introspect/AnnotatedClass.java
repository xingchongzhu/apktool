...
public final class AnnotatedClass extends Annotated implements TypeResolutionContext {
    ...
    AnnotatedClass(JavaType javaType, Class<?> cls, List<JavaType> list, Class<?> cls2, Annotations annotations, TypeBindings typeBindings, AnnotationIntrospector annotationIntrospector, MixInResolver mixInResolver, TypeFactory typeFactory, boolean z) {
        this._type = javaType;
        this._class = cls;
    ...
    public Iterable<Annotation> annotations() {
        ...
        if (!(annotations instanceof OneAnnotation) && !(annotations instanceof TwoAnnotations)) {
