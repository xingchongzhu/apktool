...
public final class IndexedListSerializer extends AsArraySerializerBase<List<?>> {
    ...
    public ContainerSerializer<?> _withValueTypeSerializer(TypeSerializer typeSerializer) {
        IndexedListSerializer indexedListSerializer = new IndexedListSerializer(this, this._property, typeSerializer, this._elementSerializer, this._unwrapSingle);
    ...
    public IndexedListSerializer withResolved(BeanProperty beanProperty, TypeSerializer typeSerializer, JsonSerializer<?> jsonSerializer, Boolean bool) {
        IndexedListSerializer indexedListSerializer = new IndexedListSerializer(this, beanProperty, typeSerializer, jsonSerializer, bool);
        return indexedListSerializer;
    }
}
