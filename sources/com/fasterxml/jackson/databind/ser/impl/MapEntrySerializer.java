    ...
    static /* synthetic */ class C18061 {
        ...
        static {
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.databind.ser.impl.MapEntrySerializer.C18061.<clinit>():void");
        }
    }
        ...
        if (beanProperty != null) {
            ...
            if (findPropertyInclusion != null) {
                ...
                if (contentInclusion != Include.USE_DEFAULTS) {
                    int i = C18061.$SwitchMap$com$fasterxml$jackson$annotation$JsonInclude$Include[contentInclusion.ordinal()];
                    if (i == 1) {
