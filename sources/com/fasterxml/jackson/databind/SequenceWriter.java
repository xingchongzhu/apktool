...
public class SequenceWriter implements Versioned, Closeable, Flushable {
    ...
    private final JsonSerializer<Object> _findAndAddDynamic(Class<?> cls) throws JsonMappingException {
        ...
        if (typeSerializer == null) {
            ...
            serializerAndMapResult = this._dynamicSerializers.addSerializer(cls, (JsonSerializer<Object>) new TypeWrappedSerializer<Object>(typeSerializer, this._provider.findValueSerializer(cls, (BeanProperty) null)));
        }
    ...
    private final JsonSerializer<Object> _findAndAddDynamic(JavaType javaType) throws JsonMappingException {
        ...
        if (typeSerializer == null) {
            ...
            serializerAndMapResult = this._dynamicSerializers.addSerializer(javaType, (JsonSerializer<Object>) new TypeWrappedSerializer<Object>(typeSerializer, this._provider.findValueSerializer(javaType, (BeanProperty) null)));
        }
        this._dynamicSerializers = serializerAndMapResult.map;
        return serializerAndMapResult.serializer;
    }
