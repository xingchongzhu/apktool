...
public @interface JsonAutoDetect {
    ...
    static /* synthetic */ class C17671 {
        ...
        static final /* synthetic */ int[] f11504x23d16a11;
        ...
        static {
            ...
            L_0x0065:
                int[] r1 = f11504x23d16a11     // Catch:{ NoSuchFieldError -> 0x006f }
            ...
            L_0x006f:
                int[] r0 = f11504x23d16a11     // Catch:{ NoSuchFieldError -> 0x0079 }
            ...
            L_0x0079:
                int[] r0 = f11504x23d16a11     // Catch:{ NoSuchFieldError -> 0x0083 }
            ...
            L_0x0083:
                int[] r0 = f11504x23d16a11     // Catch:{ NoSuchFieldError -> 0x008d }
            ...
            L_0x008d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.annotation.JsonAutoDetect.C17671.<clinit>():void");
        }
    }
    ...
    public static class Value implements JacksonAnnotationValue<JsonAutoDetect>, Serializable {
        ...
        static {
            ...
            Value value = new Value(visibility, visibility, visibility, Visibility.ANY, visibility);
            DEFAULT = value;
        ...
        public static Value construct(PropertyAccessor propertyAccessor, Visibility visibility) {
            ...
            int i = C17671.$SwitchMap$com$fasterxml$jackson$annotation$PropertyAccessor[propertyAccessor.ordinal()];
            if (i != 1) {
                if (i == 2) {
    ...
    public enum Visibility {
        ...
        public boolean isVisible(Member member) {
            int i = C17671.f11504x23d16a11[ordinal()];
            if (i == 1) {
                return true;
            }
            if (i == 3) {
