...
public enum Gender {
    ...
    static /* synthetic */ class C30994 {

        /* renamed from: a */
        static final /* synthetic */ int[] f16476a = null;
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.umeng.analytics.Gender.C30994.<clinit>():void");
        }
    }
    ...
    public static com.umeng.commonsdk.statistics.proto.Gender transGender(Gender gender) {
        int i = C30994.f16476a[gender.ordinal()];
        if (i == 1) {
