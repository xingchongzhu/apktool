...
public final class MainActivity extends Hilt_MainActivity implements C3051b {
    ...
    public void mo16467i(List<String> list, List<String> list2, List<String> list3) {
        ...
        if (list.contains("android.permission.READ_PHONE_STATE") && C3052g.m20581b(this.f13610u.mo18610g(), "000000000000000")) {
            TelephonyManager telephonyManager = (TelephonyManager) ContextCompat.m1761g(this, TelephonyManager.class);
