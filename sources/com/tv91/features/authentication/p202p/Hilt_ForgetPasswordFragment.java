...
abstract class Hilt_ForgetPasswordFragment extends KeyedFragment implements GeneratedComponentManager {
    ...
    /* renamed from: d0 */
    private ContextWrapper f13766d0;

    /* renamed from: e0 */
    private volatile FragmentComponentManager f13767e0;

    /* renamed from: f0 */
    private final Object f13768f0 = new Object();

    /* renamed from: g0 */
    private boolean f13769g0 = false;
    ...
    /* renamed from: o2 */
    private void m17040o2() {
        if (this.f13766d0 == null) {
            this.f13766d0 = FragmentComponentManager.m22929b(super.mo2367I(), this);
            mo16672p2();
        }
    }
    ...
    public void mo2359F0(Activity activity) {
        ...
        ContextWrapper contextWrapper = this.f13766d0;
    ...
    public final Object mo16498g() {
        return mo16670m2().mo16498g();
    }

    /* renamed from: m2 */
    public final FragmentComponentManager mo16670m2() {
        if (this.f13767e0 == null) {
            synchronized (this.f13768f0) {
                if (this.f13767e0 == null) {
                    this.f13767e0 = mo16671n2();
                }
            }
        }
    ...
    /* access modifiers changed from: protected */
    /* renamed from: p2 */
    public void mo16672p2() {
        if (!this.f13769g0) {
            this.f13769g0 = true;
            ((ForgetPasswordFragment_GeneratedInjector) mo16498g()).mo16667n((ForgetPasswordFragment) UnsafeCasts.m22903a(this));
        }
    }
}
