...
import com.bumptech.glide.load.p158p.p159d.RoundedCorners;
...
import com.tv91.p255z.C3066f.C3067a;
import com.tv91.p255z.C3066f.C3069c;
...
public final class GlideImageLoader implements C3066f {
    ...
    public void mo18696f(BiConsumer<String, Bitmap> aVar) {
        ...
        if (cVar == null || C3052g.m20586g(cVar.mo18700a())) {
            this.f16211b = null;
            return;
        }
