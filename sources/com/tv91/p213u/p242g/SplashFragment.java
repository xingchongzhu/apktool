...
public final class SplashFragment extends Hilt_SplashFragment {
    ...
    public /* synthetic */ void mo18293L2(Url url) {
        ...
        this.f15821w0 = C3052g.m20582c("%s/update.html?sid=%d&pid=%d", url.webUrl, Integer.valueOf(this.f15808j0.mo18606c()), Integer.valueOf(0));
    }
    ...
    public /* synthetic */ void mo18298W2(ErrorBundle cVar, ErrorBundle cVar2) {
        ...
        this.f15821w0 = C3052g.m20582c("%s/update.html?sid=%d&pid=%d", this.f15811m0, Integer.valueOf(this.f15808j0.mo18606c()), Integer.valueOf(0));
        ((SplashScreen) this.f15817s0.mo4947a()).mo16552g0(cVar.mo17114d());
    }
    ...
    public /* synthetic */ void mo18299Y2() {
        mo18305r2(C3052g.m20582c("%s?sid=%d&pid=%d", this.f15820v0.updateUrl, Integer.valueOf(this.f15808j0.mo18606c()), Integer.valueOf(0)), Files.m20562b(mo2385O1()));
    }

    /* access modifiers changed from: private */
    /* renamed from: Z2 */
    public /* synthetic */ void mo18300a3() {
        this.f15818t0.mo18588e(new BrowserKey(C3052g.m20582c("%s?sid=%d&pid=%d", this.f15820v0.downloadUrl, Integer.valueOf(this.f15808j0.mo18606c()), Integer.valueOf(0))));
    }
