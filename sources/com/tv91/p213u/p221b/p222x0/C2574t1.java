...
public final class C2574t1 extends ObservableUseCase<C2575a> {
    ...
    public C2574t1(Schedulers bVar, DownloadApi cVar, C3058c cVar2) {
        super(bVar);
        this.f15147i = cVar;
        this.f15148j = cVar2;
    }
