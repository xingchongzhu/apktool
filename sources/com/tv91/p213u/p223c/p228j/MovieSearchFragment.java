...
public final class MovieSearchFragment extends Hilt_MovieSearchFragment {
    ...
    public /* synthetic */ void mo17927x2(CharSequence charSequence) {
        this.f15478p0 = !C3052g.m20581b(this.f15477o0, charSequence);
    ...
    public void mo17923I2(String str) {
        if (!C3052g.m20586g(str) && !this.f15475m0 && this.f15476n0) {
            if (!C3052g.m20581b(this.f15477o0, str)) {
                this.f15474l0 = 0;
            }
    ...
    public void mo2437g1() {
        ...
        if (!this.f15473k0.isEmpty() || C3052g.m20586g(this.f15477o0)) {
