...
final class MovieView extends BasicView implements MovieScreen {
    ...
    private static class C2605e extends ViewHolder<Movie> {
        ...
        public void mo16844M(Movie movie) {
            this.f13991v.mo18692b(C3052g.m20586g(movie.poster) ? movie.image : movie.poster).mo18695e(R.drawable.photo_poster_medium).mo18693c(R.drawable.photo_poster_medium).mo18697g(this.f15202w.f14366b);
    ...
    public void mo17615M(Movie movie) {
        ...
        this.f15187e.f14442C.setText(mo16815o2(R.string.movie_play_count, C3052g.m20583d(Integer.valueOf(movie.playCount))));
    ...
    public void mo17639u(Movie movie) {
        ...
        this.f15187e.f14442C.setText(mo16815o2(R.string.movie_play_count, C3052g.m20583d(Integer.valueOf(movie.playCount))));
        this.f15187e.f14463s.setText(C3052g.m20583d(Integer.valueOf(movie.favoriteCount)));
        this.f15187e.f14470z.setText(movie.name);
