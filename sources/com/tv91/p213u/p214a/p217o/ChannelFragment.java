...
public final class ChannelFragment extends BottomBarFragment<ChannelScreen> {
    ...
    public /* synthetic */ void mo17220H2(ExternalSource externalSource) {
        this.f14829p0.mo18588e(new BrowserKey(C3052g.m20582c("%s?sid=%s", externalSource.url, Integer.valueOf(this.f14824k0.mo18606c()))));
    }
    ...
    public void mo2437g1() {
        ...
        if (aVar.f14831b) {
            ...
            mo2405W().mo2808m().mo2938e(aVar2.mo18580l(), aVar2.mo18581m()).mo2516h();
            mo17221I2();
        }
    }
