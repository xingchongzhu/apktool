...
public enum CharacterSetECI {
    ...
    /* renamed from: B */
    private static final Map<Integer, CharacterSetECI> f9989B = null;

    /* renamed from: C */
    private static final Map<String, CharacterSetECI> f9990C = null;
    ...
    static {
        ...
        for (CharacterSetECI cVar : values()) {
            for (int valueOf : cVar.f10018G) {
                f9989B.put(Integer.valueOf(valueOf), cVar);
            }
            f9990C.put(cVar.name(), cVar);
            for (String put : cVar.f10019H) {
                f9990C.put(put, cVar);
            }
        }
    }
    ...
    /* renamed from: a */
    public static CharacterSetECI m12115a(String str) {
        return (CharacterSetECI) f9990C.get(str);
    }

    /* renamed from: b */
    public int mo8578b() {
        return this.f10018G[0];
    }

    private CharacterSetECI(int i, String... strArr) {
        this.f10018G = new int[]{i};
        this.f10019H = strArr;
    }
