...
final class DownloadAdapter extends RecyclerAdapter<DownloadRecord, C2482b> {
    ...
    static class C2482b extends ViewHolder<DownloadRecord> {
        ...
        private int m18290X(DownloadRecord aVar) {
            Uri parse = FragmentUtils.m20586g(aVar.f14103e) ? null : Uri.parse(aVar.f14103e);
            if (parse == null || !FragmentUtils.m20581b(parse.getScheme(), "file")) {
                return 0;
            }
        ...
        private void m18295d0(int i, boolean z) {
            ...
            this.f14978w.f14306h.setText(FragmentUtils.m20582c("%d%%", Integer.valueOf(i)));
