...
final class SearchView extends BasicView implements C2594a {
    ...
    private static class C2777c extends ViewHolder<Movie> {
        ...
        public void mo16844M(Movie movie) {
            this.f13991v.mo18692b(FragmentUtils.m20586g(movie.poster) ? movie.image : movie.poster).mo18695e(R.drawable.photo_poster_medium).mo18693c(R.drawable.photo_poster_medium).mo18697g(this.f15482w.f14366b);
