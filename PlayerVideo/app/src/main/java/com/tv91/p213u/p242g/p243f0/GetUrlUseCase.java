...
public final class GetUrlUseCase extends ObservableUseCase<C2345e> {
    ...
    public Url mo18348q(String str) throws Exception {
        ...
        if (X == null || FragmentUtils.m20586g(X.apiUrl) || FragmentUtils.m20586g(X.webUrl)) {
            throw new JsonException("url or url.apiUrl or url.webUrl is empty");
        }
        Url url = new Url(m20154o(X.apiUrl).toLowerCase(), m20154o(X.webUrl).toLowerCase(), FragmentUtils.m20586g(X.novelUrl) ? "" : m20154o(X.novelUrl).toLowerCase(), m20154o(X.apiUrl2), m20154o(X.reportUrl));
