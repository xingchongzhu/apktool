...
class MoviesView extends BasicView implements MoviesScreenPlayer {
    ...
    private static class C2739b extends C0407d0 {
        ...
        public void mo17874M(Movie movie) {
            this.f15415u.mo18692b(FragmentUtils.m20586g(movie.poster) ? movie.image : movie.poster).mo18695e(R.drawable.photo_poster_large).mo18693c(R.drawable.photo_poster_large).mo18697g(this.f15416v);
        ...
        public void mo17875N(Movie movie) {
            this.f15415u.mo18692b(FragmentUtils.m20586g(movie.poster) ? movie.image : movie.poster).mo18695e(R.drawable.photo_poster_medium).mo18693c(R.drawable.photo_poster_medium).mo18697g(this.f15416v);
            this.f15417w.setText(movie.name);
            this.f15418x.setVisibility(movie.createTime != null ? 0 : 8);
            this.f15418x.setText(this.f15414t.getString(R.string.movie_create_date, new Object[]{movie.createTime}));
        }
    ...
    MoviesView(LayoutMoviesBinding uVar, String str, C2742e eVar, int i) {
        ...
        this.f15410f = gVar;
        this.f15412h = i;
        gVar.mo16830r(!FragmentUtils.m20586g(str));
        gVar.mo16829q(str);
