...
public final class StartDownObservableUseCase extends ObservableUseCase<StartDownObservableUseCase.StartDownloadInterface> {
    ...
    /* compiled from: StartDownloadUseCase */
    public interface StartDownloadInterface {
        /* renamed from: a */
    ...
    public StartDownObservableUseCase(Schedulers bVar, C3061b bVar2, DownloadApi cVar, C3060h hVar, C3058c cVar2) {
        super(bVar);
        this.f15156i = bVar2;
        this.f15157j = cVar;
        this.f15158k = hVar;
    ...
    public void m18743H(ErrorBundle cVar) {
        for (StartDownloadInterface a : mo17052d()) {
            a.mo17367a(cVar);
        }
    }
    ...
    /* renamed from: M */
    public void m18746M() {
        for (StartDownloadInterface s : mo17052d()) {
            s.mo17388s();
        }
    }
    ...
    public void m18744J(DownloadRecord aVar, Number number) {
        for (StartDownloadInterface k : mo17052d()) {
    ...
    /* renamed from: O */
    public void m18748O() {
        for (StartDownloadInterface l : mo17052d()) {
            l.mo17378l();
        }
    }
    ...
    public void m18755v(DownloadRecord aVar, File file) {
        for (StartDownloadInterface u : mo17052d()) {
