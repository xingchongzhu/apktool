...
final class FavoriteView extends BasicView implements FavoriteScreen {
    ...
    private static class C2700c extends ViewHolder<Movie> {
        ...
        public void m19190V(Movie movie, boolean z) {
            this.f13991v.mo18692b(FragmentUtils.m20586g(movie.poster) ? movie.image : movie.poster).mo18695e(R.drawable.photo_poster_medium).mo18693c(R.drawable.photo_poster_medium).mo18697g(this.f15340w.f14382c);
