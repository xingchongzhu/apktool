...
public final class DownloadObservableUseCase extends ObservableUseCase<DownloadObservableUseCase.DownloadInterface> {
    ...
    public DownloadObservableUseCase(Schedulers bVar, DownloadApi cVar, C3058c cVar2) {
        super(bVar);
        this.f15138i = cVar;
        this.f15139j = cVar2;
    }
    ...
    /* renamed from: A */
    public void m18699A() {
        for (DownloadInterface m : mo17052d()) {
            m.mo17379m();
        }
    }
    ...
    public void m18704u(DownloadRecord aVar) {
        for (DownloadInterface i : mo17052d()) {
            i.mo17374i(aVar);
        }
    }
    ...
    private void m18706y(ErrorBundle cVar) {
        for (DownloadInterface a : mo17052d()) {
            a.mo17367a(cVar);
        }
    }
    ...
    /* renamed from: z */
    public void m18707z() {
        for (DownloadInterface t : mo17052d()) {
            t.mo17389t();
        }
    }
