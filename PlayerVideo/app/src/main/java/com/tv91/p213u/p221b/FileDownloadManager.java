...
import com.tv91.p213u.p221b.p222x0.DownloadObservableUseCase.DownloadInterface;
import com.tv91.p213u.p221b.p222x0.RemoveDownObservableUseCase;
import com.tv91.p213u.p221b.p222x0.RemoveDownObservableUseCase.RemoveDownloadInterface;
import com.tv91.p213u.p221b.p222x0.StartDownObservableUseCase;
import com.tv91.p213u.p221b.p222x0.StartDownObservableUseCase.StartDownloadInterface;
...
public final class FileDownloadManager {
    ...
    /* renamed from: c */
    private final StartDownObservableUseCase f15009c;

    /* renamed from: d */
    private final DownloadObservableUseCase f15010d;
    /* access modifiers changed from: private */

    /* renamed from: e */
    public final RemoveDownObservableUseCase f15011e;
    ...
    class C2493a implements RemoveDownloadInterface {
        C2493a() {
        }
    ...
    private class C2494b implements C2550e {
        ...
        public void mo17436b(List<DownloadRecord> list) {
            for (DownloadRecord aVar : list) {
                ...
                if ((aVar2 == C2335a.DOWNLOADING || aVar2 == C2335a.QUEUED || aVar2 == C2335a.PAUSED || aVar2 == C2335a.EXPIRED) && !FragmentUtils.m20586g(aVar.f14103e)) {
    ...
    /* compiled from: FileDownloadManager */
    public interface C2495c extends C2515a, StartDownloadInterface, DownloadInterface, RemoveDownloadInterface {
    }

    public FileDownloadManager(LoadDownloadRecordsUseCase m1Var, C2514f1 f1Var, StartDownObservableUseCase v1Var, DownloadObservableUseCase r1Var, RemoveDownObservableUseCase t1Var, UpdateDownloadUseCase w1Var) {
        this.f15007a = m1Var;
        this.f15008b = f1Var;
        this.f15009c = v1Var;
        this.f15010d = r1Var;
