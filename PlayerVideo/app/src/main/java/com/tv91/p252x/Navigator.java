...
public final class Navigator {
    ...
    private void m20633g(C3056b bVar, FragmentKey cVar, FragmentKey cVar2) {
        ...
        if (cVar != null) {
            ...
            if (i == 1) {
                cVar.setCustomAnimations(m, false);
            } else if (i == 2) {
                cVar.setCustomAnimations(m, false);
            } else if (i == 3) {
                cVar.setCustomAnimations(m, false);
            }
            Fragment i0 = this.f16079c.mo2799i0(cVar.getClassName());
            if (i0 != null) {
        ...
        Fragment i02 = this.f16079c.mo2799i0(cVar2.getClassName());
        int i2 = C3055a.f16081a[bVar.ordinal()];
        if (i2 == 1) {
            cVar2.setCustomAnimations(m, true);
        } else if (i2 == 2) {
            cVar2.setCustomAnimations(m, true);
        } else if (i2 == 3) {
            cVar2.setCustomAnimations(m, true);
        ...
        if (i02 == null) {
            m.mo2936c(this.f16080d, cVar2.createFragment(), cVar2.getClassName());
        } else if (i02.mo2483y0()) {
            m.mo2943q(this.f16080d, cVar2.createFragment(), cVar2.getClassName());
