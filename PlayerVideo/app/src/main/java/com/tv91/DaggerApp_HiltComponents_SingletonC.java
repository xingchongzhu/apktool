...
import com.tv91.p213u.p221b.p222x0.DownloadObservableUseCase;
import com.tv91.p213u.p221b.p222x0.RemoveDownObservableUseCase;
import com.tv91.p213u.p221b.p222x0.StartDownObservableUseCase;
...
import dagger.hilt.ActivityRetainedLifecycle;
import dagger.hilt.android.builders.ActivityComponentBuilder;
import dagger.hilt.android.builders.ActivityRetainedComponentBuilder;
import dagger.hilt.android.builders.FragmentComponentBuilder;
import dagger.hilt.android.internal.modules.ApplicationContextModule;
import dagger.hilt.android.modules.ApplicationContextModule;
import dagger.hilt.android.modules.ApplicationContextModule_ProvideContextFactory;
...
public final class DaggerApp_HiltComponents_SingletonC extends C2322i {
    ...
    private final class C2325c extends C2320g {
        ...
        private final class C2326a implements ActivityComponentBuilder {
            ...
            public C2326a mo16923b(Activity activity) {
                this.f14066a = (Activity) Preconditions.checkNotNull(activity);
                return this;
            }

            /* renamed from: d */
            public App_HiltComponents mo16922a() {
                Preconditions.checkBuilderRequirement(this.f14066a, Activity.class);
        ...
        private final class C2327b extends App_HiltComponents {
            ...
            private final class C2328a implements FragmentComponentBuilder {
                ...
                public C2321h mo16928a() {
                    Preconditions.checkBuilderRequirement(this.f14069a, Fragment.class);
                    return new C2329b(this.f14069a);
                }

                /* renamed from: d */
                public C2328a mo16929b(Fragment fragment) {
                    this.f14069a = (Fragment) Preconditions.checkNotNull(fragment);
                    return this;
                }
            }
            ...
            private final class C2329b extends C2321h {
                ...
                /* renamed from: n */
                public void forgetPassword(ForgetPasswordFragment vVar) {
                    m17551V(vVar);
                }
    ...
    public static final class C2330d {
        ...
        public C2330d mo16953a(ApplicationContextModule aVar) {
            this.f14072a = (ApplicationContextModule) Preconditions.checkNotNull(aVar);
            return this;
        }

        /* renamed from: b */
        public C2322i mo16954b() {
            Preconditions.checkBuilderRequirement(this.f14072a, ApplicationContextModule.class);
    ...
    /* renamed from: E */
    private DownloadObservableUseCase m17460E() {
        return new DownloadObservableUseCase(m17483t(), m17468M(), m17488y());
    }

    /* renamed from: F */
    private RemoveDownObservableUseCase m17461F() {
        return new RemoveDownObservableUseCase(m17483t(), m17468M(), m17488y());
    }
    ...
    /* renamed from: H */
    private StartDownObservableUseCase m17463H() {
        StartDownObservableUseCase v1Var = new StartDownObservableUseCase(m17483t(), m17467L(), m17468M(), m17466K(), m17488y());
        return v1Var;
    }
