...
public final class C1655c {
    ...
    public final String mo9622b() {
        ...
        Set<Entry<String,String>> elems = treeMap.entrySet(); //将m1中所有元素收集起来组成一个集合

        Iterator<Entry<String,String>> elemsIt = elems.iterator();
        while(elemsIt.hasNext() ){
            Entry<String,String> entry = elemsIt.next(); //获取集合中的元素
